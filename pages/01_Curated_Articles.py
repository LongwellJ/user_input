...
import pandas as pd
import uuid
from app import client, db, users_collection, rankings_collection, satisfaction_collection, format_article, load_articles_from_mongodb, load_css, authenticate_user
